              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-white/90">
                    ...
                    backend systems to enhance performance and security. During
                    this period, some features may be temporarily unavailable.
                  </p>
                  ...
                  <p className="mt-4 text-white/90">
                    While we work on restoring full functionality, we invite you
                    to:
                  </p>
                  ...
                  <p className="mt-4 text-white/90">
                    ...
                    improve our services. Thank you for choosing ElevareApp.
                  </p>
                </div>
              </div>
